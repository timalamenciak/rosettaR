...
- [ ] Submit rosettaR for [rOpenSci peer review](https://ropensci.org/software-review/).
- [ ] Update and submit [Rosetta Statements pre-print](https://arxiv.org/abs/2407.20007).
