...
This outlines how to propose a change to rosettaR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("timalamenciak/rosettaR", fork = TRUE)`.
...
Please note that the rosettaR project is released with a [Contributor
Code of
Conduct](https://timalamenciak.github.io/rosettaR/CODE_OF_CONDUCT.md).
