...
#' dataframe must have one column called "TemplateID" that contains the ID of the
#' template used to interpret the row.
#' @param templates A Rosetta Statement template library created by the
#' initLibrary function.
#'
#' @returns A data frame statement library containing the statements and associated templates.
#' @export
#'
#' @examples
